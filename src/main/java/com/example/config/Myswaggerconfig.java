...
public class Myswaggerconfig {
	...
	private ApiInfo metadata() {
		return new ApiInfoBuilder().title("Spring Bot Services").description("API reference guide for developers").termsOfServiceUrl("localhost:8080/").contact("Batra, Yatin").version("1.0").build();	
	}
}